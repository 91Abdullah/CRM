...
-->*}
{strip}
<div class="container-fluid" id="TwitterDetails">
			...
			<thead>
				<tr class="blockHeader">
					<th colspan="2" class="mediumWidthType">
						<span class="alignMiddle">{vtranslate('LBL_TWEET_CONFIG', $QUALIFIED_MODULE)}</span>
					</th>
				</tr>
			</thead>
			<tbody>
                            ...
                            {foreach item=FIELD_TYPE key=FIELD_NAME from=$FIELDS}
                                <tr>
									...
									<td style="border-left: none;">
										<span>{$RECORD_MODEL->get($FIELD_NAME)}</span>
									</td>
								</tr>
                            {/foreach}
