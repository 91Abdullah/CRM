...
Settings_Vtiger_Index_Js("Settings_Tweet_Index_Js", {},{
   
    /*
    * function to Save the PBXManager Server Details
    */
    saveTwitterServerDetails : function(form) {
	...
	registerEditViewEvents : function() {
		...
		params.onValidationComplete = function(form, valid){
			if(valid) {
				thisInstance.saveTwitterServerDetails(form);
				return valid;
			}
		}
	...
	registerDetailViewEvents : function() {
		...
		var container = jQuery('#TwitterDetails');
