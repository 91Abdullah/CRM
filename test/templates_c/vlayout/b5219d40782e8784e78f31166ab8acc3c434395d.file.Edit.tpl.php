<?php /* Smarty version Smarty-3.1.7, created on 2018-03-05 11:56:17
         compiled from "D:\xampp5.6\htdocs\crm\includes\runtime/../../layouts/vlayout\modules\Settings\Tweet\Edit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:123995a9d1e4d2b42a3-98586084%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b5219d40782e8784e78f31166ab8acc3c434395d' => 
    array (
      0 => 'D:\\xampp5.6\\htdocs\\crm\\includes\\runtime/../../layouts/vlayout\\modules\\Settings\\Tweet\\Edit.tpl',
      1 => 1520250963,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '123995a9d1e4d2b42a3-98586084',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5a9d1e4d826c6',
  'variables' => 
  array (
    'MODULE_MODEL' => 0,
    'QUALIFIED_MODULE' => 0,
...
<?php if ($_valid && !is_callable('content_5a9d1e4d826c6')) {function content_5a9d1e4d826c6($_smarty_tpl) {?>
<div class="container-fluid"><?php $_smarty_tpl->tpl_vars['MODULE_MODEL'] = new Smarty_variable(Settings_Tweet_Module_Model::getCleanInstance(), null, 0);?><form id="MyModal" class="form-horizontal" data-detail-url="<?php echo $_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getDetailViewUrl();?>
"><div class="widget_header row-fluid"><div class="span8"><h3><?php echo vtranslate('LBL_TWEET',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</a></div></div></div><hr><div class="contents row-fluid"><table class="table table-bordered table-condensed themeTableColor"><thead><tr class="blockHeader"><th colspan="2" class="mediumWidthType"><span class="alignMiddle"><?php echo vtranslate('LBL_TWEET_SETTINGS',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
" /></td></tr><?php } ?><input type="hidden" name="module" value="Tweet"/><input type="hidden" name="action" value="SaveAjax"/><input type="hidden" name="parent" value="Settings"/><input type="hidden" name="id" value="<?php echo $_smarty_tpl->tpl_vars['RECORD_ID']->value;?>
